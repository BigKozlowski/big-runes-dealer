const runeWords = [
  ...
  },
  {
    ...
    itemType: "Missile Weapons",
    itemTypes: ["Amazon bow", "Bow", "Crossbow"],
    level: 65,
    attributes: [
  ...
  },
  {
    ...
    itemTypes: ["Paladin shield", "Shield", "Body armor"],
    level: 61,
    attributes: [
      "BOTH:",
  ...
  },
  {
    name: "Delirium",
    runes: ["Lem", "Ist", "Io"],
    itemType: "Headgear (all types)",
    itemTypes: ["Barbarian helmet", "Circlet", "Druid pelt", "Helmet"],
    level: 51,
    attributes: [
  ...
  },
  {
    ...
    runes: ["Ko", "Ko", "Mal"],
    itemType: "Shields",
    itemTypes: ["Paladin shield", "Shield"],
    level: 49,
    attributes: [
      "+20% Faster Hit Recovery",
  ...
  },
  {
    ...
    runes: ["Eth", "Lum"],
    itemType: "Shields",
    itemTypes: ["Necromancer shrunken head", "Paladin shield", "Shield"],
    level: 37,
    attributes: [
      "+1 To All Skills",
      "+10% Faster Cast Rate",
  ...
  },
  {
    ...
    itemTypes: ["Sword", "Paladin shield", "Shield"],
    level: 25,
    attributes: [
      "BOTH:",
      "+2 To All Skills",
